                ...
                {questionTypeOptions.map(option => (
                  <button
                    ...
                    style={{
                      ...
                      backgroundColor: formData.questionTypes.includes(option.id) ? 'rgba(244, 109, 0, 0.1)' : 'transparent',
                      color: formData.questionTypes.includes(option.id) ? '#F46D00' : 'var(--tg-text-color)',
                      fontSize: '14px',
                      cursor: 'pointer',
                      transition: 'all 0.2s ease',
                      display: 'flex',
