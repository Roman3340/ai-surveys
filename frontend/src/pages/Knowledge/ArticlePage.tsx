...
const articles: ArticleContent[] = [
  ...
  },
  {
    ...
    content: {
      introduction: 'Сегментация аудитории позволяет получить более точные и релевантные данные. Разделяя респондентов на группы, вы можете анализировать различия в их мнениях и предпочтениях.',
      sections: [
        {
  ...
  },
  {
    ...
    content: {
      introduction: 'Время проведения опроса может значительно повлиять на качество и количество ответов. Правильный выбор времени — это не мелочь, а важный фактор успеха исследования.',
      sections: [
        {
          title: '1. Время дня',
